...
('Tecnologia', 'Eventos de tecnologia, programacao e inovacao'),
('Educacao', 'Cursos, palestras e encontros academicos'),
('Cultura', 'Shows, exposicoes e eventos culturais'),
('Negocios', 'Feiras, congressos e networking empresarial'),
('Esportes', 'Competicoes e atividades esportivas');
